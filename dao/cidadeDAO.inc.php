...
class CidadeDao{
    ...
    public function cadastrar(Cidade $cidade){
        $sql = $this->con->prepare("insert into cidades (cidade, estado, CEP, valorfrete_porPeso) values (:cidade, :estado, :cep, :valorfrete_porPeso)");
    ...
    public function alterar($id_cidade, Cidade $cidade){
        $sql = $this->con->prepare("update cidades set cidade = :cidade, estado = :estado, CEP = :cep, valorfrete_porPeso = :valorfrete_porPeso where id_cidade = :id");
    ...
    private function hidratar($row){
        $cidade = new Cidade();
        $cidade->setCidade($row->cidade, $row->estado, $row->CEP, $row->valorfrete_porPeso);
